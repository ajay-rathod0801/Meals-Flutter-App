...
class CreateSmartRecipies extends StatefulWidget {
  const CreateSmartRecipies({super.key});

  @override
  State<CreateSmartRecipies> createState() => _CreateSmartRecipiesState();
}

class _CreateSmartRecipiesState extends State<CreateSmartRecipies> {
